        ...
        <div className="bg-[#141414] border border-white/10 rounded-3xl p-8">
          ...
          <form onSubmit={handleSubmit} className="space-y-6">
            ...
            <div className="flex items-center justify-between">
              <div className="flex items-center space-x-2">
                <Checkbox
                  ...
                  disabled={isLoading}
                  className="border-white/20 data-[state=checked]:bg-[#E4FF2C] data-[state=checked]:border-[#E4FF2C]"
                />
                <Label
                  htmlFor="remember"
              ...
              <Link
                ...
                className="text-[#E4FF2C] hover:text-[#E4FF2C]/80 text-sm font-medium"
              >
                Forgot password?
              </Link>
            </div>
            ...
            <Button
              type="submit"
              disabled={isLoading}
              className="w-full bg-[#E4FF2C] text-[#0a0a0a] hover:bg-[#E4FF2C]/90 font-bold h-12 rounded-xl"
            >
              {isLoading ? (
